...
public class WriterAritcleHandler implements CommandHandler{
	...
	private String processSubmit(HttpServletRequest req, HttpServletResponse resp) {
		//사용자에게 입력받은 게시글 내용의 무결성을 체크하기 위해 
		...
		WriteRequest writeRequest = new WriteRequest(new Writer(authUser.getUserId(), 
				authUser.getName()), 
		...
		int newArticleNum = writeArticleService.write(writeRequest);
